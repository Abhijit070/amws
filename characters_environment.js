...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Click on the PlayGame buttom to start the game ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function manualControl(character){
  ...
  if(character.live){
    ...
    if(noseX<400&&!noseX>400&&!noseY<187){ 
...
function jumping(character){
	if( (noseY<187&&character.live) || (touchIsDown&&character.live) ){
